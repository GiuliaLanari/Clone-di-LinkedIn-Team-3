        ...
        <Navbar expand="lg" id="navbar" className="bg-white sticky-lg-top border-bottom py-0 px-0 pt-1 mb-3">
            <Container>
                <div className="d-flex">
                    <NavbarBrand href="/" className="linkedin logo">
                        <Col className="d-flex flex-row mt-1">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#0A66C2" class="bi bi-linkedin" viewBox="0 0 24 24">
                ...
                <div className="d-flex justify-content-end align-items-center">
                    ...
                    <div className="d-flex flex-column align-items-center bord "> 
                        {/* For Business */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#666666" class="bi bi-grid-3x3-gap-fill" viewBox="0 0 24 24" focusable="false">
