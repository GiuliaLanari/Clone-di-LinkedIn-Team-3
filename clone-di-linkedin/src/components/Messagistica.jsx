            ...
            <div className="d-flex justify-content-between">
              <div className="d-flex align-items-center mb-2">
                <img
                  ...
                  style={{ width: "30px" }}
                />
                <h6 className="m-0 ms-1 me-5 h6mess">Messaggistica</h6>
              </div>
          ...
          {dropdownOpen && (
            <Card.Body className="cardbody">
              <div className="search-container pt-0">
                ...
                <input type="text" placeholder="Cerca messaggi" className="messearch" />
              ...
              >
                <div>
                  ...
                  />
                  <h4 className="text-secondary mt-4 text-dark" style={{ display: "block" }}>
                    Ancora nessun <br />
                    messaggio
                  </h4>
                  <p className="text-secondary my-4 text-dark" style={{ display: "block" }}>
                  ...
                  <Button className="btn btn-outline-dark rounded-pill text-secondary buttonPepe d-flex align-items-center justify-content-center m-auto">
                    Invia un messaggio
                  </Button>
                </div>
              </div>
